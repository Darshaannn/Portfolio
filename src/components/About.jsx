...
const About = () => {
    return (
        <section className="min-h-screen w-full flex items-center justify-center relative py-12 md:py-16 overflow-hidden">
            {/* Background elements */}
            ...
            <div className="container mx-auto px-6 relative z-10 w-full max-w-6xl">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-display text-white neon-glow">
                        About <span className="text-white text-stroke">Me</span>
                    </h2>
                    <div className="w-24 h-1 bg-[var(--color-brand-accent)] mx-auto mt-4 rounded-full"></div>
                </motion.div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-10 items-center">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true, margin: "-100px" }}
                        className="lg:col-span-7 space-y-4 md:space-y-6 glass-card p-6 md:p-8 lg:p-10 rounded-2xl border border-white/5"
                    >
                        {/* Who I am */}
                        <div>
                            <h3 className="text-lg md:text-xl font-display text-[var(--color-brand-accent)] mb-2 flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg md:text-xl font-display text-white mb-2 flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg md:text-xl font-display text-[var(--color-brand-neon-cyan)] mb-2 flex items-center gap-3">
